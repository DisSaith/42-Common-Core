...
/*   Updated: 2026/01/08 14:55:44 by acohaut          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	load_textures(t_game *game)
{
	...
	if (!game->map.exit.img)
		return (0);
	load_xpm(game->mlx, &game->player_sprite, "textures_bonus/down.xpm");
	if (!game->player_sprite.img)
		return (0);
	load_xpm(game->mlx, &game->enemy, "textures_bonus/enemy.xpm");
	if (!game->enemy.img)
		return (0);
	return (1);
}
