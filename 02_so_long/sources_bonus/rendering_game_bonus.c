...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   rendering_game_bonus.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: acohaut <marvin@42.fr>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/15 16:25:52 by acohaut           #+#    #+#             */
/*   Updated: 2026/01/08 15:14:54 by acohaut          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_text_on_window(t_game *game)
{
	...
	nbr = ft_itoa(game->player_moves);
	text = ft_strjoin("number of movements = ", nbr);
	mlx_string_put(game->mlx, game->window, 20, 20, 0x000000, text);
	free(nbr);
	free(text);
}
